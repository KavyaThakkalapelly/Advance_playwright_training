...
//let objects = fs.readFileSync('./tests/TestData/create_order_All_scenarios_TestData.json')
//const orders = JSON.parse(objects);
const orders= JSON.parse(JSON.stringify(require("../Test_Data/create_order_All_scenarios_TestData.json")))
